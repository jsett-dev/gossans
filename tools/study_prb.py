    ...
    <div class="col">
      ...
      <div class="tbl">
        <table>
          ...
          <tr><td>Turner</td><td>257</td><td>325,713</td><td><b>50,604</b></td></tr>
          <tr><td>Parkman</td><td>125</td><td>307,848</td><td>43,451</td></tr>
          <tr><td>Frontier</td><td>110</td><td>277,181</td><td>33,294</td></tr>
          <tr><td>Sussex</td><td>101</td><td>223,342</td><td>40,899</td></tr>
          <tr><td>Teapot</td><td>77</td><td>277,070</td><td>32,922</td></tr>
          <tr><td>Shannon</td><td>22</td><td>479,711</td><td><b>60,183</b></td></tr>
        </table>
      </div>
      <div class="prose">
        <p>
        ...
        <p>
          The Shannon is top of the normalised column and should be read with
          care. Twenty-two wells is a thin population, and a small sample of
          good wells is the commonest way a ranking like this misleads. It is
          shown because leaving it out would be a choice about what the reader
          sees, not a fact about the rock.
        </p>
        <p class="costline">
          Recomputed 17 September 2026. The formation names underlying this
          table were being split across several spellings until a fault in the
          name canonicaliser was fixed, which is why the Turner and Frontier
          counts have risen since first publication, by two wells and thirteen.
